"""
Genesis Backend — Flask application factory.
...
def create_app(config_class=Config):
    ...
    if should_log_startup:
        logger.info("=" * 50)
        logger.info("Genesis Backend starting...")
        logger.info("=" * 50)
    ...
    @app.before_request
    def log_request():
        logger = get_logger('genesis.request')
    ...
    if should_log_startup:
        logger.info("Genesis Backend ready")
